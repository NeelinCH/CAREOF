        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="mb-6">
                        <a href="{{ route('plantas.show', $planta->id) }}" class="inline-flex items-center text-sm text-gray-500 hover:text-gray-700">
                            <i class="fas fa-arrow-left mr-1"></i> Volver a la planta
                        </a>
                        <h3 class="text-lg font-medium text-gray-900 mt-2">Actividades de {{ $planta->nombre }}</h3>
                        <p class="text-sm text-gray-600">Historial de acciones realizadas en esta planta</p>
                    </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-blue-700">
                                        No hay actividades registradas para esta planta.
                                    </p>
                                </div>
                            </div>
                        </div>
