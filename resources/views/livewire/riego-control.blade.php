<div class="bg-white p-6 rounded-xl border border-gray-200 shadow-md">
    ...
    <div class="mb-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
        <div class="flex items-start">
            <div class="flex-shrink-0">
                <i class="fas fa-exclamation-triangle text-gray-500 text-xl mr-3"></i>
            </div>
            <div>
                <h5 class="font-semibold text-gray-800 mb-1">Importante: Conexión Arduino en desarrollo</h5>
                <p class="text-gray-600 text-sm">La funcionalidad de conexión con Arduino se encuentra actualmente en etapa de desarrollo y puede presentar fallos o comportamientos inesperados. Te recomendamos utilizar esta característica teniendo en cuenta la presente aclaración.</p>
            </div>
        </div>
    </div>

    <div class="flex items-center justify-between mb-6">
        <h4 class="font-bold text-lg flex items-center text-gray-800">
            <i class="fas fa-microchip mr-3 text-xl text-gray-600"></i> 
        ...
        <div class="flex items-center space-x-3">
            ...
            @else
                <div class="flex items-center {{ $conectado ? 'text-green-600' : 'text-red-500' }}">
            ...
            <button wire:click="verificarConexion" 
                    ...
                    class="inline-flex items-center px-3 py-1 bg-gray-800 text-white rounded-md text-xs hover:bg-gray-900 transition disabled:opacity-50">
    ...
    @if($mensaje)
        <div class="mb-4 p-3 rounded-lg border 
            {{ $tipoMensaje === 'success' ? 'bg-green-50 border-green-200 text-green-700' : 
            ($tipoMensaje === 'error' ? 'bg-red-50 border-red-200 text-red-700' : 
            ($tipoMensaje === 'warning' ? 'bg-yellow-50 border-yellow-200 text-yellow-700' : 
    ...
    <!-- Estado del Arduino -->
    <div class="mb-4 p-3 rounded border bg-gray-50 text-gray-700 border-gray-200 transition-all duration-300">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <div class="flex items-center {{ $conectado ? 'text-green-600' : 'text-red-500' }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <div>
                ...
                <select wire:model="puertoSeleccionado" 
                        class="w-full rounded border-gray-300 shadow-sm focus:border-gray-500 focus:ring-1 focus:ring-gray-500">
            ...
            <div class="flex flex-col justify-end">
                <button wire:click="escanearPuertos" 
                        wire:loading.attr="disabled"
                        class="w-full bg-gray-700 hover:bg-gray-800 text-white font-medium py-2 px-4 rounded transition disabled:opacity-50 flex items-center justify-center">
            ...
            <div class="flex flex-col justify-end">
                <button wire:click="testComunicacion" 
                        wire:loading.attr="disabled"
                        class="w-full bg-gray-800 hover:bg-black text-white font-medium py-2 px-4 rounded transition disabled:opacity-50 flex items-center justify-center">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="number" 
                           ...
                           max="5000" 
                           step="50"
                           class="w-full rounded border-gray-300 shadow-sm focus:border-gray-500 focus:ring-1 focus:ring-gray-500 pr-12">
